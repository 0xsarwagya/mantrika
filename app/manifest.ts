...
export default function manifest(): MetadataRoute.Manifest {
    return {
        name: 'Mantrika',
        short_name: 'Mantrika',
        description: 'Mantrika is an innovative AI assistant created by Sarwagya Singh and fine-tuned with DeepSeek. Built for general-purpose tasks, it delivers smart insights, efficient solutions, and friendly guidance—all communicated naturally in Hinglish, blending Hindi and simple English seamlessly.',
        start_url: '/',
        display: 'standalone',
